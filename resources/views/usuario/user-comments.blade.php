				...
				<div class="row">
					...
					<div class="col-xl-9 col-md-8">
						<div class="row mb-4">
							...
							<div class="col-sm-3">
								<button class="btn btn-md btn-primary float-right" >¡Hacerme Plus!</button>
							</div>
						</div>
						<div class="card mb-0">
												...
												<table class="table table-hover table-center mb-0 datatable" style="width:100%">
													...
													<tbody>
														@for ($i = 0; $i < count($reviews) ; $i++)
															...
															<tr>
																<td>{{ $review->id }}</td>
																<td><a href="{{route('agencia.detalles',$review->agencia[0]->id)}}" target="_blank" >
																	{{ $review->agencia[0]->nombre }}<a>
																	</td>
																	<td>
																		@if($review->autor)
																		{{ $review->autor }}
