...
<body>
    ...
    <p>Tu solicitud será revizada. Te avisaremos cuando la hallamos revizado.</p>
    ...
    <p><strong>Membresía: </strong> {{ $solicitud->membresia }}</p>
    ...
    <p><strong>INE: </strong> <img class="img-fluid desk" width="25px" src="{{ asset('assets/landing/check.png') }}"
            alt="check A&R"></p>

    <p><strong>Acta constitutiva de la empresa: </strong> <img class="img-fluid desk" width="25px"
            src="{{ asset('assets/landing/check.png') }}" alt="check A&R"></p>

    <p><strong>Identificación del apoderado legal: </strong> <img class="img-fluid desk" width="25px"
            src="{{ asset('assets/landing/check.png') }}" alt="check A&R"></p>

    <p><strong>Poder Notarial: </strong> <img class="img-fluid desk" width="25px"
            src="{{ asset('assets/landing/check.png') }}" alt="check A&R"></p>

    <p><strong>Hoja de Registro del R.F.C.: </strong> <img class="img-fluid desk" width="25px"
            src="{{ asset('assets/landing/check.png') }}" alt="check A&R"></p>

    <p><strong>Comprobante de domicilio: </strong> <img class="img-fluid desk" width="25px"
            src="{{ asset('assets/landing/check.png') }}" alt="check A&R"></p>
