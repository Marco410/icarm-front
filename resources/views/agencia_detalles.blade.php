                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6 form-group">
                                                    ...
                                                    <input type="datetime-local" class="form-control" name="date_cita" id="date_cita" >
                                                </div>
                                                <div class="col-sm-12 form-group">
                                                    <label for="">Tipo de cliente</label>
                                                    <select class="form-control" name="tipo_cliente" id="motivo">
                                                        <option value="">Seleccione:</option>
                                                        <option value="Soy cliente del concesionario">Soy cliente del concesionario</option>
                                                    </select>
                                                </div>
                                                <div class="col-sm-12 form-group">
