            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{ route('user.login') }}">
                        ...
                        <button class="btn btn-primary btn-block btn-lg login-btn" type="submit">Iniciar
                            Sesión</button>
                        {{--  <div class="login-or"> <span class="or-line"></span>
                            <span class="span-or">o</span>
                        </div>
                        <div class="row form-row social-login">
                            <div class="col-6"> <a href="{{ route('login.facebook', 'redirect_to=' . url()->full()) }}"
                                    class="btn btn-facebook btn-block"><i class="fab fa-facebook-f mr-1"></i> Iniciar
                                    Sesión</a>
                            </div>
                            <div class="col-6"> <a
                                    href="{{ route('login.google', 'redirect_to=' . strval(url()->full())) }}"
                                    class="btn btn-google btn-block"><i class="fab fa-google mr-1"></i> Iniciar
                                    Sesión</a>
                            </div>
                        </div> --}}
                        ...
                        <div class="text-center dont-have">¿No tienes una cuenta? <a
