            ...
            },
            {
                ...
                "render": function (data, type, row, meta) {
                    ...
                    if (parseInt(row.answers_count) == 0) {
                        btn_answer = '<a class="btn btn-sm bg-primary-light" data-toggle="modal" data-target="#modalComentario" data-whatever="' + row.text + '" data-autorid="' + autor_id + '" data-autor="' + autor + '" data-id="' + row.id + '" onclick="comment(this)" > <i class="fas fa-reply" ></i> Responder</a >';
                    } else {
